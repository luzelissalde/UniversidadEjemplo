...
public class ConsultaAlumnoMateria extends javax.swing.JInternalFrame {
    ...
    private void jCBmateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCBmateriaActionPerformed
        ...
        //borrarFilas();
        for (Inscripcion prod : inscripcion.obtenerInscripcionesPorAlumno(mat.getIdMateria())) {
       System.out.println("ID de Alumno: " + prod.getAlumno().getIdAlumno());
       System.out.println("DNI del Alumno: " + prod.getAlumno().getDni());
       System.out.println("Apellido del Alumno: " + prod.getAlumno().getApellido());
       System.out.println("Nombre del Alumno: " + prod.getAlumno().getNombre());
       break;
        }
        for (Inscripcion prod : inscripcion.obtenerInscripcionesPorAlumno(mat.getIdMateria())) {
           modelo.addRow(new Object[]{prod.getAlumno().getIdAlumno(), prod.getAlumno().getDni(), prod.getAlumno().getApellido(), prod.getAlumno().getNombre()});
