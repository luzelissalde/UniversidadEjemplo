...
public class vistaMateria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        panelRound1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-2, 63, 460, 16));

        getContentPane().add(panelRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 460, 65));
        ...
        getContentPane().add(panelRound2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 460, 290));
...
//                jRadioEstadoMateria.setSelected(mate.isActivo());
                } else if (!mate.isActivo()) {
                    mate.setActivo(true);
                    int confirmacion = JOptionPane.showOptionDialog(this, "La materia que esta buscando se ha dado de baja ¿Desea volver a activarla?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones, si);
...
//                else if (!mate.isActivo()) {
//                    mate.setActivo(true);
//                    int confirmacion = JOptionPane.showOptionDialog(this, "La materia que esta buscando se ha dado de baja ¿Desea modificar activarla?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones, si);
//                    System.out.println(confirmacion);
//                    if (confirmacion == 0) {
//                        materia.modificarMateria(mate);
//                    }
